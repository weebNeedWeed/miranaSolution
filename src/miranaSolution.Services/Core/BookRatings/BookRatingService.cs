...
public class BookRatingService : IBookRatingService
{
    ...
    public BookRatingService(MiranaDbContext context, UserManager<AppUser> userManager,
    ...
    public async Task DeleteBookRatingAsync(DeleteBookRatingRequest request)
    {
        ...
        if (rating is null) throw new BookRatingNotFoundException("The rating does not exist.");
    ...
    public async Task<GetAllBookRatingsByUserIdResponse> GetAllBookRatingsByUserIdAsync(
        GetAllBookRatingsByUserIdRequest request)
    {
        if (await _userManager.FindByIdAsync(request.UserId.ToString()) is null)
            throw new UserNotFoundException("The user with given Id does not exist.");
    ...
    public async Task<GetAllBookRatingsByBookIdResponse> GetAllBookRatingsByBookIdAsync(
        GetAllBookRatingsByBookIdRequest request)
    {
        if (await _context.Books.FindAsync(request.BookId) is null)
            throw new BookNotFoundException("The book with given Id does not exist.");
